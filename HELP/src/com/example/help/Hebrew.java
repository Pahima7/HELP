...
public class Hebrew extends Activity implements OnClickListener,
	...
	private void init() {
		...
		questions[0] = new Question(2, "���� 1", arr);
		questions[1] = new Question(2, "���� 2", arr);
		questions[2] = new Question(2, "���� 3", arr);
		questions[3] = new Question(2, "���� 4", arr);
		questions[4] = new Question(2, "���� 5", arr);
